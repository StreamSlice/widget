...
export const Icons = {
  ...
  minimize: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M6 19h12v2H6z"/></svg>`,
  ...
  stream: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M21 3H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H3V5h18v14zM9 8h2v8H9zm4 2h2v6h-2z"/></svg>`,
